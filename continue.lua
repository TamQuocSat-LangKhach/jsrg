...
Fk:loadTranslationTable{
  ["js__xuyou"] = "许攸",
  ["chanpan"] = "馋叛",--有可能看错技能名
  [":chanpan"] = "回合结束时，你可以变更势力，然后摸X张牌并执行一个额外的出牌阶段。此阶段结束时，所以势力与你相同的角色可以将一张牌当【决斗】"..
  "对你使用（X为势力与你相同的其他角色数）。",
  ["qingxix"] = "轻袭",
  [":qingxix"] = "群势力技，出牌阶段对每名角色限一次，你可以选择一名手牌数小于你的角色，你将手牌弃至与其相同，然后视为对其使用一张无次数距离限制的刺【杀】。",
  ["kuimie"] = "殨灭",--？
  [":kuimie"] = "魏势力技，出牌阶段限一次，你可以选择一名手牌数大于你的角色，视为对其使用一张无次数距离限制的火【杀】。此牌造成伤害后，你将其手牌弃置"..
  "至与你相同。",
}
...
Fk:loadTranslationTable{
  ...
  ["dingwei"] = "定围",--大概不对
  [":dingwei"] = "魏势力技，出牌阶段开始时，你可以获得攻击范围内任意名角色各一张牌，该回合结束时，这些角色中本回合未受到过伤害的角色各获得你的一张牌。",
}
