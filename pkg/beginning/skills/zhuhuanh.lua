...
Fk:loadTranslationTable{
  ...
  ['#zhuhuanh-choose'] = '诛宦：令一名其他角色选择：受到1点伤害并弃置%arg张牌 / 你回复1点体力并摸%arg张牌',
...
zhuhuanh:addEffect(fk.EventPhaseStart, {
  can_trigger = function(self, event, target, player)
    return target == player and player:hasSkill(zhuhuanh.name) and player.phase == Player.Start and not player:isKongcheng()
  end,
