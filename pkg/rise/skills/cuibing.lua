...
Fk:loadTranslationTable{
  ...
  [':cuibing'] = '锁定技，出牌阶段结束时，你将手牌摸或弃置至X张（X为你攻击范围内的角色数且至多为5）。若你因此弃置了牌，你弃置场上至多等量张牌；否则你跳过弃牌阶段。',
}
...
cuibing:addEffect(fk.EventPhaseEnd, {
  ...
  can_trigger = function(self, event, target, player, data)
    return target == player and player:hasSkill(cuibing.name) and player.phase == Player.Play and
